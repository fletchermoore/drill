...
class DrillReviewerBottomBar:
    def __init__(self, reviewer: DrillReviewer) -> None:
...
class DrillReviewer:
    ...
    def show(self) -> None:
        ...
        self.bottom.web.set_bridge_command(self._linkHandler, DrillReviewerBottomBar(self))
        self._reps: int = None
        self.nextCard()
...
""".format(
    ...
    def _initWeb(self) -> None:
        ...
        self.bottom.web.stdHtml(
            ...
            context=DrillReviewerBottomBar(self),
        )
